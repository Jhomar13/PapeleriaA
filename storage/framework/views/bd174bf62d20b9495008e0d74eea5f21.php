<div class="py-12 bg-gray-50 min-h-screen"
    ...
    data-logs-labels='<?php echo json_encode($nivelesLabels, 15, 512) ?>'
    data-logs-count='<?php echo json_encode($nivelesCount, 15, 512) ?>'
    data-users-labels='<?php echo json_encode($usuariosLabels, 15, 512) ?>'
    data-users-count='<?php echo json_encode($usuariosCount, 15, 512) ?>'
    data-trend-labels='<?php echo json_encode($trendLabels, 15, 512) ?>'
    data-trend-count='<?php echo json_encode($trendCount, 15, 512) ?>'
    data-actions-labels='<?php echo json_encode($accionesLabels, 15, 512) ?>'
    data-actions-count='<?php echo json_encode($accionesCount, 15, 512) ?>'>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-blue-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($totalHoy); ?></p>
                    </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-red-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-red-600"><?php echo e($totalCriticos); ?></p>
                    </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-green-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($totalUsuarios); ?></p>
                    </div>
...
</div><?php /**PATH /home/jpartesp/Desktop/EstaSI/PapeleriaARTES-main/resources/views/livewire/reportes-graficos.blade.php ENDPATH**/ ?>