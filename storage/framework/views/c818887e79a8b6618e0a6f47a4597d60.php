    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
            ...
            <div class="relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-[#161615]">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-gray-800 dark:text-white"><?php echo e($totalProductos); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-[#161615]">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-gray-800 dark:text-white"><?php echo e($totalCategorias); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden rounded-xl border border-red-100 bg-red-50 p-6 shadow-sm dark:border-red-900/50 dark:bg-red-900/10">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-red-700 dark:text-red-400"><?php echo e($bajoStock); ?></p>
                    </div>
                </div>
            </div>
        ...
        <div class="relative h-full flex-1 overflow-hidden rounded-xl border border-neutral-200 bg-white shadow-sm dark:border-neutral-700 dark:bg-[#161615]">
            <div class="p-6">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($listaUrgente->count() > 0): ?>
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $listaUrgente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <tr>
                                        <td class="px-4 py-3 text-sm font-medium text-gray-900 dark:text-gray-100">
                                            <?php echo e($item->nombrepro); ?>
                                        ...
                                        <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">
                                            <span class="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10 dark:bg-gray-800 dark:text-gray-400">
                                                <?php echo e($item->categoria->nombrecat ?? 'Sin Cat'); ?>
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <span class="inline-flex items-center rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10 dark:bg-red-900/20 dark:text-red-400">
                                                <?php echo e($item->stockpro); ?> unid.
                                            </span>
                                        </td>
                                        <td class="px-4 py-3 text-sm text-blue-600 hover:text-blue-800">
                                            <a href="<?php echo e(route('productos')); ?>">Ver Inventario &rarr;</a>
                                        </td>
                                    </tr>
...
<?php endif; ?><?php /**PATH /home/jpartesp/Desktop/EstaSI/PapeleriaARTES-main/resources/views/dashboard.blade.php ENDPATH**/ ?>